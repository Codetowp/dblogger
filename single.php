...
if(have_posts()):		  
	while ( have_posts() ) : the_post();
		...
		<div id="single-banner" style="background-image: url(<?php echo esc_url( $img ); ?>);">
			<div class="content wow fdeInUp">
				<div class="container "> 
					...
					<!--/breadcrumb-->
					<h1><?php the_title(); ?> </h1>
					<header class="entry-header"><span class="date-article"><?php  dblogger_posted_on(); ?></span> </header>
				</div>
			</div>
		</div>
	<?php endwhile;
		...
		<div class="row wow fdeInUp"> 
			...
			<div class="col-md-8 col-sm-8 single-post">
				...
				<div class="author-box">
					<?php echo get_avatar( get_the_author_meta('user_email'), '100', '' ); ?> <!--<img alt="" src="img/a-1.jpg"  class="avatar " height="100" width="100">-->
