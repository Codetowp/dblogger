...
<section id="theme-banner" style="background-image: url(<?php echo esc_url( the_post_thumbnail_url('full') ); ?>);">
	<div class="content wow fadeInUp">
		...
		<!--/breadcrumb-->
			<h1><?php the_title(); ?></h1>
			<header class="entry-header"><a href="#"> </a><span class="date-article"><?php dblogger_posted_on(); ?></span><!-- in <span class="byline"><span class="author vcard"><a href="#">WORDPRESS</a> ,<a href="#"> BLOG</a></span></span>--> </header>
		</div>
	</div>
</section>
