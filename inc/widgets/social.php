...
class Dblogger_Premium extends WP_Widget{
	...
	*/
	...
	?>
			...
			<p>
			<label for="<?php echo esc_attr( $this->get_field_id('social_title') ); ?>"><?php esc_html_e( 'Title', 'dblogger' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('facebook_url') ); ?>"><?php esc_html_e( 'Facebook Url', 'dblogger' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('twitter_url') ); ?>"><?php esc_html_e( 'Twitter Url', 'dblogger' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('google_url') ); ?>"><?php esc_html_e( 'Google Url', 'dblogger' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('inst_title') ); ?>"><?php esc_html_e( 'Instagram Title', 'dblogger' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('dribbble') ); ?>"><?php esc_html_e( 'Dribbble Url', 'dblogger' ); ?></label><br/>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id('behance') ); ?>"><?php esc_html_e( 'Behance Url', 'dblogger' ); ?></label><br/>
